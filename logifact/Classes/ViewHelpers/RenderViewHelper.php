...
class RenderViewHelper extends AbstractViewHelper
{
    ...
    public static function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        foreach ($overrideConfiguration['renderables']['0']['renderables'] as $key => $field) {
            if(is_array($field['properties']['fluidAdditionalAttributes'])){
                $overrideConfiguration['renderables']['0']['renderables'][$key]['properties']['fluidAdditionalAttributes']['showlabel'] =$arguments['settings']['showlabels'];
            }

        }
        //DebugUtility::debug($overrideConfiguration);
