<?php
namespace Kuchesearch\Kuchesearch\Domain\Repository;
...
class IndexSearchRepository
{
    ...
    public function doSearch($searchWords, $freeIndexUid = -1)
    {
        ...
        \TYPO3\CMS\Core\Utility\DebugUtility::debug(count($lis));*/
