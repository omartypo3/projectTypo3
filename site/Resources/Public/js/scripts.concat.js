...
;(function (factory) {
    ...
    var smoothCanvas = (function() {
        ...
        return function(w, h, canvasElm) {
            ...
            can.width = w * ratio;
            can.height = h * ratio;
            can.style.width = (w/10)-2 + "rem";
            can.style.height = (h/10)-2 + "rem";
    ...
    Indicator.prototype = {
        ...
        value: function(val) {
            ...
            if (indOption.displayNumber) {
                ...
                if (/Safari/i.test(uA) && /Apple Computer/.test(vendor) && !/Mobi|Android/i.test(uA)) {
                    ctx.font = weight + " " + "200" + "% " + cFont;
                } else if (isMobile.iOS()) {
                    ctx.font = weight + " " + "200" + "% " + cFont;
                } else {
                    ctx.font = weight + " " + fontSize + "rem " + cFont;
                }
        ...
        animate: function(val) {
            var indOption = this.indOption,
                ...
                minVal = indOption.minValue,
                maxVal = indOption.maxValue,
                frameNum = indOption.frameNum || (indOption.percentage ? 100 : 100),
    ...
    radialIndicator.defaults = {
        ...
        barColor: '#f00', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
...
function hideShowOnScroll() {
    ...
    if (interCountry) {
        interCountry.forEach(function (country) {
            if (academy) {
                if (scrolled > academy.offsetTop + 1) country.classList.add('scale-show-bg');else country.classList.remove('scale-show-bg');
            }
        });
    }
    ...
    //tours    
    var prevBtnTours = document.querySelector('.tours__btn--prev');
    var nextBtnTours = document.querySelector('.tours__btn--next');
    var toursSection = document.querySelector('.tours');
    if (toursSection && nextBtnTours && prevBtnTours) {
        if (scrolled > toursSection.offsetTop - 170) {
    ...
    //big-slider__slider
    var prevBtnBigSlider = document.querySelector('.big-slider__btn--prev');
    var nextBtnBigSlider = document.querySelector('.big-slider__btn--next');
    var bigSliderSection = document.querySelector('.big-slider');
    if (bigSliderSection && prevBtnBigSlider && nextBtnBigSlider) {
        if (scrolled > bigSliderSection.offsetTop + -170) {
            prevBtnBigSlider.classList.add('to-left-prev');
            nextBtnBigSlider.classList.add('to-right-next');
        } else {
            prevBtnBigSlider.classList.remove('to-left-prev');
            nextBtnBigSlider.classList.remove('to-right-next');
        }
    }
    // players slider
    var playerImgs = document.querySelectorAll('.players-slider__slide img');
    var PlayersSlider = document.querySelector('.big-slider');
    if (PlayersSlider && playerImgs) {
        playerImgs.forEach(function (playerImg) {
            if (scrolled > PlayersSlider.offsetTop + 1) playerImg.classList.add('player-img-show');else playerImg.classList.remove('player-img-show');
        });
    }
}
...
var swiperPartners = new Swiper('.sgeagles-partners__swiper', {
    ...
    speed: 2000,
    pagination: {
        el: '.sgeagles-partners__pagination',
        clickable: true
    },
    initialSlide: 2,
    navigation: {
        nextEl: '.sgeagles-partners__btn--next',
        prevEl: '.sgeagles-partners__btn--prev'
    },
    loop: true,
    breakpoints: {
        480: {
...
function scrolToWhyInter() {
    ...
    whyInter.scrollIntoView({ behavior: 'smooth' });
}
...
function scrollToSections() {
    ...
    var whyInter = document.getElementById('why-inter');
    var threePillars = document.getElementById('three-pillars');
    var quotes = document.getElementById('quotes');
    var sgeagles = document.getElementById('sgeagles');
    ...
    sections.map(function (section) {
        if (section.section) {
            section.section.addEventListener('click', function () {
    ...
    if (buttonnext) {
        buttonnext.addEventListener('click', function () {
            ...
            if (spanactive.nextElementSibling.classList.contains('swiper-pagination-bullet')) {
                ...
                document.querySelector('.' + spanactive.nextElementSibling.id).scrollIntoView({ behavior: 'smooth' });
        ...
        buttonprevious.addEventListener('click', function () {
            ...
            if (spanactive.previousElementSibling.classList.contains('swiper-pagination-bullet')) {
                if (spanactive.previousElementSibling.id == 'three-pillars') {
                    console.log(spanactive.previousElementSibling.id);
                    document.querySelector('.scroll-to-sections__pagination').classList.add('black-pagination');
                } else {
                    document.querySelector('.scroll-to-sections__pagination').classList.remove('black-pagination');
                }
                ...
                document.querySelector('.' + spanactive.previousElementSibling.id).scrollIntoView({ behavior: 'smooth' });
            }
        });
    }
}
...
window.addEventListener('scroll', function () {
    ...
    document.querySelectorAll('section').forEach(function (item) {
        ...
        if (parseFloat(topDistance) - 500 < scrollTop) {
            if (activeBullet) {
