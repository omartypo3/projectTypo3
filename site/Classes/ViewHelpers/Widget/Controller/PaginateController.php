...
namespace sitetheme\site\ViewHelpers\Widget\Controller;
...
class PaginateController extends \GeorgRinger\News\ViewHelpers\Widget\Controller\PaginateController
{
    ...
    public function indexAction($currentPage = 1, $nbitems = 0)
    {
        ...
        $this->templatePath = 'typo3conf/ext/site/Resources/Ext/News/Private/Templates/ViewHelpers/Widget/Paginate/Index.html';
