<?php
namespace DLD\Dld\Property\TypeConverter;
...
class UploadedFileReferenceConverter extends AbstractTypeConverter
{
    ...
    protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration)
    {
        ...
        $allowedFileExtensions = $configuration->getConfigurationValue('DLD\\Dld\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
        ...
        $uploadFolderId = $configuration->getConfigurationValue('DLD\\Dld\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
        ...
        $conflictMode = $configuration->getConfigurationValue('DLD\\Dld\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $defaultConflictMode;
