...
{
    /**
     * @var \DLD\Dld\Controller\EventController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\DLD\Dld\Controller\EventController::class)
    ...
    public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView()
    {
        ...
        $eventRepository = $this->getMockBuilder(\DLD\Dld\Domain\Repository\EventRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $event = new \DLD\Dld\Domain\Model\Event();
