...
{
    /**
     * @var \FRONTAL\FagBesichtigung\Controller\EventController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\FRONTAL\FagBesichtigung\Controller\EventController::class)
    ...
    public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView()
    {
        ...
        $eventRepository = $this->getMockBuilder(\FRONTAL\FagBesichtigung\Domain\Repository\EventRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $event = new \FRONTAL\FagBesichtigung\Domain\Model\Event();
