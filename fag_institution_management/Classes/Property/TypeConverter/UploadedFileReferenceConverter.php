<?php
namespace FRONTAL\FagInstitutionManagement\Property\TypeConverter;
...
class UploadedFileReferenceConverter extends AbstractTypeConverter
{
    ...
    protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration)
    {
        ...
        $allowedFileExtensions = $configuration->getConfigurationValue('FRONTAL\\FagInstitutionManagement\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
        ...
        $uploadFolderId = $configuration->getConfigurationValue('FRONTAL\\FagInstitutionManagement\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
        ...
        $conflictMode = $configuration->getConfigurationValue('FRONTAL\\FagInstitutionManagement\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $defaultConflictMode;
     ...
     * @return \DLD\Dld\Domain\Model\FileReference
     */
    ...
    protected function createFileReferenceFromFalFileReferenceObject(FalFileReference $falFileReference, $resourcePointer = null)
    {
        if ($resourcePointer === null) {
            /** @var $fileReference \DLD\Dld\Domain\Model\FileReference */
